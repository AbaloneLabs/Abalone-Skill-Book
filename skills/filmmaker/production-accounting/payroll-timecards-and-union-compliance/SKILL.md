---
name: payroll_timecards_and_union_compliance.md
description: Use when the agent is evaluating, planning, reviewing, troubleshooting, or giving notes on payroll timecards and union compliance in production accounting for a film, documentary, commercial, branded, animation, or streaming production; trigger contexts include accounting, payroll, timecards, union, compliance; important risks include creative intent, budget and schedule realism, rights clearance, participant or crew safety, workflow continuity, client or distributor approval, and final deliverability.
---

# Payroll Timecards And Union Compliance
...
Payroll Timecards And Union Compliance can look solved when the frame, page, schedule, or export looks better. The hidden cost may land in overtime, clearance, participant harm, unusable audio, missing coverage, unsupported claims, revision churn, or rejected deliverables. Ask which department inherits the fix.
...
- [ ] Is the payroll timecards and union compliance decision located in the production chain, with the responsible approver and affected downstream teams named?
